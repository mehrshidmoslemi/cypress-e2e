...
module.exports = defineConfig({
  env: {
    ...
    STUDIO_API_ENTERPRISE_EMAIL: process.env.STUDIO_API_ENTERPRISE_EMAIL,
    STUDIO_API_ENTERPRISE_PASSWORD: process.env.STUDIO_API_ENTERPRISE_PASSWORD,
    STUDIO_API_PROPLUS_MONTHLY_EMAIL: process.env.STUDIO_API_PROPLUS_MONTHLY_EMAIL,
    STUDIO_API_PROPLUS_MONTHLY_PASSWORD: process.env.STUDIO_API_PROPLUS_MONTHLY_PASSWORD,
    STUDIO_API_PROPLUS_YEARLY_EMAIL: process.env.STUDIO_API_PROPLUS_YEARLY_EMAIL,
    STUDIO_API_PROPLUS_YEARLY_PASSWORD: process.env.STUDIO_API_PROPLUS_YEARLY_PASSWORD,
  },
