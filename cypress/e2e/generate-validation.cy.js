...
describe('validation generation', () => {
    it('validation generation', () => {
      ...
      // Go to uploader
      cy.get('#v5-home-tool-backsplash-change').click()
  
      // Upload image
      cy.get('input[type="file"]').selectFile('cypress/fixtures/images/BC-test.jpg', {
        force: true,
      }).wait(7000)
      ...
      //selecting space
      cy.get('#v5-tool-backsplash-change-space-kitchen').click()

      //selecting style drop down
      cy.contains('button', 'Grey Marble').find('span.i-tabler\\:chevron-down').click()
  
      //selecting style
      cy.get('#v5-tool-backsplash-change-material-black-marble').click()
      ...
      //regenerate flow
      cy.contains('AI Backsplash Change').click()
      ...
      // selecting style
      cy.get('button').contains('Grey Marble').click()
  
      //selecting style 
      cy.get('#v5-tool-backsplash-change-material-white-marble').click()
  
      //generate button click
      cy.get('#v5-tool-backsplash-change-generate-button').click().wait(30000)
